...
//! // use pqcrypto::sign::falconpadded1024::*;
...
simple_struct!(
    PublicKey,
    ffi::PQCLEAN_FALCONPADDED1024_CLEAN_CRYPTO_PUBLICKEYBYTES
);
simple_struct!(
    SecretKey,
    ffi::PQCLEAN_FALCONPADDED1024_CLEAN_CRYPTO_SECRETKEYBYTES
);
...
impl DetachedSignature {
    fn new() -> Self {
        DetachedSignature([0u8; ffi::PQCLEAN_FALCONPADDED1024_CLEAN_CRYPTO_BYTES], 0)
    }
}
...
impl primitive::DetachedSignature for DetachedSignature {
    ...
    fn from_bytes(bytes: &[u8]) -> Result<Self> {
        ...
        let expected = ffi::PQCLEAN_FALCONPADDED1024_CLEAN_CRYPTO_BYTES;
        if actual > expected {
        ...
        let mut array = [0u8; ffi::PQCLEAN_FALCONPADDED1024_CLEAN_CRYPTO_BYTES];
...
pub const fn signature_bytes() -> usize {
    ffi::PQCLEAN_FALCONPADDED1024_CLEAN_CRYPTO_BYTES
}
...
/// Generate a falcon-padded-1024 keypair
pub fn keypair() -> (PublicKey, SecretKey) {
    ...
    gen_keypair!(PQCLEAN_FALCONPADDED1024_CLEAN_crypto_sign_keypair)
}
...
pub fn sign(msg: &[u8], sk: &SecretKey) -> SignedMessage {
    ...
    gen_signature!(PQCLEAN_FALCONPADDED1024_CLEAN_crypto_sign, msg, sk)
}
...
pub fn open(
    ...
    open_signed!(PQCLEAN_FALCONPADDED1024_CLEAN_crypto_sign_open, sm, pk)
}
