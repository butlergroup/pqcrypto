...
simple_struct!(PublicKey, ffi::PQCLEAN_MLDSA87_CLEAN_CRYPTO_PUBLICKEYBYTES);
...
impl DetachedSignature {
    fn new() -> Self {
        DetachedSignature([0u8; ffi::PQCLEAN_MLDSA87_CLEAN_CRYPTO_BYTES], 0)
    }
}
...
impl primitive::DetachedSignature for DetachedSignature {
    ...
    fn from_bytes(bytes: &[u8]) -> Result<Self> {
        ...
        let expected = ffi::PQCLEAN_MLDSA87_CLEAN_CRYPTO_BYTES;
        if actual > expected {
        ...
        let mut array = [0u8; ffi::PQCLEAN_MLDSA87_CLEAN_CRYPTO_BYTES];
...
pub fn keypair() -> (PublicKey, SecretKey) {
    ...
    gen_keypair!(PQCLEAN_MLDSA87_CLEAN_crypto_sign_keypair)
}
...
pub fn sign(msg: &[u8], sk: &SecretKey) -> SignedMessage {
    ...
    gen_signature!(PQCLEAN_MLDSA87_CLEAN_crypto_sign, msg, sk)
}
...
pub fn sign_ctx(msg: &[u8], ctx: &[u8], sk: &SecretKey) -> SignedMessage {
    ...
    gen_signature_ctx!(PQCLEAN_MLDSA87_CLEAN_crypto_sign_ctx, msg, ctx, sk)
}
...
pub fn open(
    ...
    open_signed!(PQCLEAN_MLDSA87_CLEAN_crypto_sign_open, sm, pk)
}
...
pub fn open_ctx(
    ...
    open_signed_ctx!(PQCLEAN_MLDSA87_CLEAN_crypto_sign_open_ctx, sm, ctx, pk)
}
...
pub fn detached_sign(msg: &[u8], sk: &SecretKey) -> DetachedSignature {
    ...
    detached_signature!(PQCLEAN_MLDSA87_CLEAN_crypto_sign_signature, msg, sk)
}
...
pub fn verify_detached_signature(
    ...
    verify_detached_sig!(PQCLEAN_MLDSA87_CLEAN_crypto_sign_verify, sig, msg, pk)
}
